window.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    els.saveProfileBtn?.addEventListener("click", async () => {
      ...
      setButtonLoading(els.saveProfileBtn, true, "Enregistrement...");
    ...
    els.changePasswordBtn?.addEventListener("click", async () => {
      ...
      setButtonLoading(els.changePasswordBtn, true, "Mise à jour...");
    ...
    els.logoutBtn?.addEventListener("click", async () => {
      setButtonLoading(els.logoutBtn, true, "Déconnexion...");
